      ...
      <div className="col-span-3">
        ...
        <div className="mb-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={addSnapshot}
              className="flex cursor-pointer items-center gap-2 rounded px-3 py-1 text-sm text-black"
              aria-label="添加图片"
              title="添加图片"
            >
            ...
            <button
              ...
              className="flex cursor-pointer items-center gap-2 rounded px-3 py-1 text-sm text-black transition"
              aria-label="切换排序"
            ...
            <button
              ...
              className={`flex cursor-pointer items-center gap-2 rounded px-3 py-1 text-sm text-black transition ${
                selectedSnapshots.size === 0 || isBatchDeleting ? 'cursor-not-allowed' : ''
              }`}
              aria-label="批量删除已选图片"
              title={
