  ...
  return (
    <>
      <div className="flex flex-row justify-between p-0.5">
        <p className="whitespace-nowrap text-white">游戏名称:</p>
        <p
      ...
      <div className="flex flex-row justify-between p-0.5 whitespace-nowrap">
        <p className="text-white">上次启动:</p>
        <p className="text-xs text-white">{formatRelativeTime(game.last_launch_time)}</p>
      </div>

      <div className="flex flex-row justify-between p-0.5 whitespace-nowrap">
        <p className="text-white">添加时间:</p>
        <p className="text-xs text-white">{formatTimeCalender(game.created_at)}</p>
      </div>
      ...
      <div className="mb-4 flex flex-row justify-between p-0.5">
