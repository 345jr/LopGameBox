    ...
    >
      ...
      >
        ...
        <div className='flex flex-row'>
          ...
          <VscArrowRight className='text-2xl mx-2 mt-2.5'/>
          <motion.button initial={{scale:1}} whileHover={{scale:1.5,color:'#fcad03'}} onClick={() => handleGetGameSize(gameId)}>
            <VscFiles className='text-2xl cursor-pointer'/>
          </motion.button>
          {size>0 && <><VscArrowRight className='text-2xl mx-2 mt-2.5'/><p className='ml-2 mt-2.5 text-lg text-black'>游戏大小:{gameSizeFormat(size)}</p></>}
        </div>
