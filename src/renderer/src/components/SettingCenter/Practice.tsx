...
const Practice = () => {
  ...
  return (
    <div ref={cardRef} className="relative h-[100px] w-[200px] [transform-style:preserve-3d]">
      <div className="absolute flex h-full w-full items-center justify-center bg-gray-100 text-2xl [backface-visibility:hidden]">
        你好
      </div>
      <div className="absolute flex h-full w-full [transform:rotateY(180deg)] items-center justify-center bg-gray-300 text-2xl [backface-visibility:hidden]">
        世界
      </div>
    </div>
  );
